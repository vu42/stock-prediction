...
Usage:
    ...
    docker exec stock-prediction-api python /app/scripts/generate_evaluation_results.py
    
    # Or copy the script inside and run it:
    docker cp docs/generate_evaluation_results.py stock-prediction-api:/app/
    docker exec stock-prediction-api python /app/generate_evaluation_results.py
    
    # Or locally with psycopg2 installed and database accessible:
    python docs/generate_evaluation_results.py
"""
...
def main():
    ...
    try:
        ...
        # If in Docker, use /app directory
